...
2. Acione a Finalização: Localize e clique no botão Finalizar captura na parte inferior da tela.
   ...
   <Image align="center" border={true} src="https://files.readme.io/7e847b995c42feeb8f05fbbba91d790729d2406865b546df0cf46529cb6beccf-Screenshot_2026-04-08_at_19.14.29.png" className="border" />
...
3. Confirme a Ação: Um modal de confirmação aparecerá alertando que nenhuma nova nota poderá ser enviada. Clique em Confirmar.
   ...
   <Image align="center" border={true} src="https://files.readme.io/433bb6587236beb9df82ebde52bbac0e35f73baa082acdab763b2590a6fa0d17-Screenshot_2026-04-08_at_19.15.01.png" className="border" />
