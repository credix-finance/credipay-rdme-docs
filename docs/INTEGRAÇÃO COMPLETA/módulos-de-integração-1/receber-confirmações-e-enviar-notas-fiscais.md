...
Sendo feito isso, a Nota Fiscal deve ser emitida e enviada em seguida (não é possível enviar uma NF antes que o pedido seja confirmado). A CrediPay somente formalizará e se comprometerá com a transação uma vez que a NF seja aceita. Para mais informações sobre os critérios de aceite, acesse [link para POST v2/orders/{orderId}/capture].
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/37c0da471f3ed0ef38ac9063ed2b2f7d41122e2cd676471451111942d2549087-Editor___Mermaid_Chart-2025-04-25-194833.png",
        "",
        ""
      ],
      "align": "center",
