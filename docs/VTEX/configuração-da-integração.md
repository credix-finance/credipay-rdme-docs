...
* **4. [Instalação dos apps](/project/credix-credipay/v2.1/docs/instalação-dos-apps)** — _CrediPay, 25 min._ Instalar o app, o conector e o ajuste de checkout.
* **5. Habilitar as parcelas** — _CrediPay, 10 min._ Feito com os IDs coletados na etapa 3.
